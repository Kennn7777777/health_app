...
export default function UpdateApptSection({ id, ...props }) {
  const { note, serviceType: service, timeslot, date } = props;
  ...
  return (
    <View>
      <View>
        ...
        >
          <Text style={styles.aptText}>Confirm New Appointment</Text>
        </TouchableOpacity>
